...
plt.plot(gene,ave1[:len(gene)], direction='in',label="moving average spatial information",color="g")
plt.plot(gene,ave2[:len(gene)], direction='in',label="moving average temporal information",color="r")
...
plt.legend(loc=4)
plt.savefig('src/img/'+read_name+'_acc.svg')
plt.savefig('src/img/'+read_name+'_acc.png')
plt.savefig('src/img/'+read_name+'_acc.pdf')
...
plt.legend(loc=1)
plt.savefig('src/img/'+read_name+'_loss.svg')
plt.savefig('src/img/'+read_name+'_loss.png')
plt.savefig('src/img/'+read_name+'_loss.pdf')